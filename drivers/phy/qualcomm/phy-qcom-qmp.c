...
static int qcom_qmp_dp_phy_init(struct phy *phy)
{
...
static int qcom_qmp_phy_configure_dp_phy(struct qmp_phy *qphy)
{
	...
	*/
	...
	if (orientation == ORIENTATION_CC2)
		writel(0x4c, qphy->pcs + QSERDES_V3_DP_PHY_MODE); // default
	else
	*/
...
static int qcom_qmp_dp_phy_power_on(struct phy *phy)
{
	struct qmp_phy *qphy = phy_get_drvdata(phy);
	struct qcom_qmp *qmp = qphy->qmp;
	const struct qmp_phy_cfg *cfg = qphy->cfg;
...
static int qcom_qmp_dp_phy_power_off(struct phy *phy)
{
	struct qmp_phy *qphy = phy_get_drvdata(phy);
	const struct qmp_phy_cfg *cfg = qphy->cfg;
...
static int qcom_qmp_dp_phy_exit(struct phy *phy)
{
	struct qmp_phy *qphy = phy_get_drvdata(phy);
	const struct qmp_phy_cfg *cfg = qphy->cfg;
...
static int qcom_qmp_phy_enable(struct phy *phy)
{
	...
	ret = qcom_qmp_phy_serdes_init(qphy);
	if (ret)
		return ret;
...
static const struct phy_ops qcom_qmp_phy_dp_ops = {
	.init		= qcom_qmp_dp_phy_init,
	.configure	= qcom_qmp_dp_phy_configure,
	.power_on	= qcom_qmp_dp_phy_power_on,
	.calibrate	= qcom_qmp_dp_phy_calibrate,
	.power_off	= qcom_qmp_dp_phy_power_off,
	.exit		= qcom_qmp_dp_phy_exit,
	.set_mode	= qcom_qmp_phy_set_mode,
	.owner		= THIS_MODULE,
};
