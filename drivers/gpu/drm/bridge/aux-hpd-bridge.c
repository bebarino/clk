...
/**
 * drm_dp_typec_bridge_assign_pins - Assign DP lanes to DisplayPort (DP)
 * altmode USB type-c pins
 * @typec_bridge_dev: Device created for the type-c bridge
 * @conf: DisplayPort altmode configure command VDO content
 * @orientation: Orientation of USB type-c port
 * @lane_mapping: Physical (index) to logical (value) USB type-c lane mapping
 *
